...
<section class="container max-w-6xl mx-auto px-6 pb-10">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            <h1 class="text-center">{{ $page->siteName }}</h1>

            <div class="flex justify-center">
                <h2 class="font-light mt-4">
                    Watchdog monitors <span class="font-extrabold">all changes</span> that occur to <span class="font-extrabold">all objects</span> in your server.
                </h2>
            </div>
            ...
            <div class="flex my-10">
                <a href="/docs/getting-started" title="{{ $page->siteName }} getting started" class="bg-gray-800 hover:bg-gray-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>
